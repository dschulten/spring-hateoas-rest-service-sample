...
public class Args extends LinkedHashMap<String, List<? extends Object>> {
	...
	public static Args of(String key, Object... values) {
		Args args = new Args();
	...
	public static Args of(String key, Object value) {
		Args args = new Args();
		args.put(key, Arrays.asList(value));
		return args;
	}

	public static Args of(String key1, Object value1, String key2, Object value2) {
		Args args = new Args();
	...
	public static Args of(String key1, Object value1, String key2, Object value2, String key3, Object value3) {
		Args args = new Args();
		args.put(key1, Arrays.asList(value1));
		args.put(key2, Arrays.asList(value2));
